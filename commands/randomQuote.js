module.exports = {
  ...
  execute(client, recievedMessage, ytdl, servers, arguments) {
  ...
  if (textNumber == 1){
	...
	recievedMessage.channel.send("What do the numbers mean, human?")	  
  } else if (textNumber == 4){
	recievedMessage.channel.send("You Have Died.")	  
  } else if (textNumber == 5){
	recievedMessage.channel.send("Thank You human! But our princess is in another castle!")	  
  } else if (textNumber == 6){
	recievedMessage.channel.send("It's a-you, human")	  
