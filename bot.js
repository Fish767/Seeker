...
client.on('ready', () => {
    ...
    generalChannel.send("Hello, Discord users! I have "+songURLs.length+" automatic songs. Here is a special one just for you!")
...
function processCommand(receivedMessage) {
  ...
  if (receivedMessage.author===client.user&&splitCommand[0]==='empty') {
    while (playsongs.length<Math.floor(songURLs.length*0.8)) {
